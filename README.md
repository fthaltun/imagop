...
Currently only png, jpg, webp images are supported.
It uses pngquant and zopfli to optimize png images, python3-pil to optimize jpg images, libwebp to optimize webp images.
